...
- **Splash Screen**: 3-second loading screen with automatic navigation
- **Onboarding**: Create or import wallet options
- **PIN Setup**: Secure 6-digit PIN creation and confirmation
- **Biometric Authentication**: Optional fingerprint/face ID setup
- **Bottom Tab Navigation**: Home, DApp Browser, History, and Accounts screens
- **Stack Navigation**: Complete flow from splash to main app
